...
const CtaOne = (props: Props) => {
    const {theme} = useTheme()
    const sectionClasses = `${theme === 'dark' ? 'text-[#fff] bg-shiptodayBlack w-full w-full flex justify-center diagonal-pattern py-8' : 'bg-shiptodayWhite text-black w-full flex justify-center diagonal-pattern py-8'}`;
  ...
  return (
    <section className={sectionClasses}>
        <div className="py-10 bg-shiptodayWhite sm:py-16 lg:py-24 z-20">
            <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                <div className="max-w-2xl mx-auto text-center">
                    <h2 className="text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl">Get full access to <br/> ShipToday</h2>
                ...
                <form action="#" method="POST" className="max-w-xl mx-auto mt-12">
                    <div className="flex flex-col items-center sm:flex-row sm:justify-center">
                        ...
                        <button type="submit" className="inline-flex items-center justify-center w-auto px-4 py-4 mt-4 font-semibold text-white transition-all duration-200 bg-shiptodayOrange border border-transparent rounded-md sm:ml-4 sm:mt-0 sm:w-auto hover:bg-indigo-700 focus:bg-indigo-700">
                            Get instant access
