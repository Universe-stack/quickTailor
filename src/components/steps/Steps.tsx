        ...
        <div className="py-10 sm:py-16 lg:py-24">
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div className="max-w-2xl mx-auto text-center">
                    <h2 className={`text-3xl font-bold leading-tight sm:text-4xl lg:text-5xl ${titleClasses}`}>How do we create success</h2>
                    <p className={`max-w-lg mx-auto mt-4 text-base leading-relaxed ${pgClasses}` }>Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis.</p>
                </div>
                ...
                <ul className="max-w-md mx-auto mt-16 space-y-12">
                    <li className="relative flex items-start">
                        ...
                        <div className="relative flex items-center justify-center flex-shrink-0 w-16 h-16 bg-white rounded-full shadow">
                            <svg className="w-10 h-10 text-shiptodayOrange" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                            </svg>
                        </div>
                        <div className="ml-6">
                            <h3 className={`text-lg font-semibold ${titleClasses}`}>Create a free account</h3>
                            <p className={`mt-4 text-base ${pgClasses}`}>Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit.</p>
                        </div>
                    </li>
                    ...
                    <li className="relative flex items-start">
                        ...
                        <div className="ml-6">
                            <h3 className={`text-lg font-semibold ${titleClasses}`}>Build your website</h3>
                            <p className={`mt-4 text-base ${pgClasses}`}>Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit.</p>
                        </div>
                    </li>
                    ...
                    <li className="relative flex items-start">
                        ...
                        <div className="ml-6">
                            <h3 className={`text-lg font-semibold ${titleClasses}`}>Release & launch</h3>
                            <p className={`mt-4 text-base ${pgClasses}`}>Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit.</p>
                        </div>
                    </li>
                </ul>
