...
const PriceCompareOne = (props: Props) => {
  ...
  return (
    <section className={`pb-10 sm:pb-16 lg:pb-24 ${sectionClasses}`}>
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="max-w-xl mx-auto text-center">
            <h2 className={`text-3xl font-bold leading-tight sm:text-4xl lg:text-5xl ${titleClasses}`}>Compare Plans</h2>
        </div>
...
export default PriceCompareOne